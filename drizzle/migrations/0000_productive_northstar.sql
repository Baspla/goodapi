...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "recommendations_to_tags" (
	"recommendation_id" integer NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "recommendations_to_tags" ADD CONSTRAINT "recommendations_to_tags_recommendation_id_recommendation_id_fk" FOREIGN KEY ("recommendation_id") REFERENCES "public"."recommendation"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "recommendations_to_tags" ADD CONSTRAINT "recommendations_to_tags_tag_id_tags_id_fk" FOREIGN KEY ("tag_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
